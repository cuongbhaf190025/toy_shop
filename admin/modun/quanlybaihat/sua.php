...
<table border="1" width="50%" style="border-collapse;">
	<form method="POST" action="modun/quanlybaihat/xuly.php?id=<?php echo $_GET['id'] ?>">
		...
		?>
		  <tr>
		    <th colspan="2" style="color: #FF3300">Fill information at here </th>
		  </tr>
			<tr >
			  	<td>Song_name</td>
			...
			<tr >
				<td colspan="2"><input type="submit" name="Add_Song" value="Edit song"></td>
			</tr>
			<tr >
				<td colspan="2"><input type="exit" name="Exit" value="Exit" action="list.php"></td>
			</tr>
			<?php
			}
			?>
